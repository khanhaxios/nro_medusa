...
//            this.createBoss(BossID.MABU);
            ...
            this.createBoss(BossID.BOSS_CHIENTHAN);
            this.createBoss(BossID.BOSS_DETU_BERUS);
            ////
            this.createBoss(BossID.BOSS_ADMIN);
...
//            this.createBoss(BossID.BOSS_NOEL);
            ...
            this.createBoss(BossID.BOSS_MOI2);
            this.createBoss(BossID.BOSS_MOI3);
            this.createBoss(BossID.BOSS_MOI4);
            this.createBoss(BossID.BOSS_MOI5);
            this.createBoss(BossID.BOSS_MOI6);
            this.createBoss(BossID.BOSS_MOI7);
            this.createBoss(BossID.BOSS_MOI8);
            this.createBoss(BossID.BOSS_MOI9);
            this.createBoss(BossID.BOSS_MOI10);
            this.createBoss(BossID.BOSS_HAC);
            this.createBoss(BossID.BOSS_HAC1);
            this.createBoss(BossID.BOSS_HAC2);
            this.createBoss(BossID.BOSS_HAC3);
            this.createBoss(BossID.BOSS_HAC4);
            this.createBoss(BossID.BOSS_HAC5);
            this.createBoss(BossID.BOSS_HAC6);
            this.createBoss(BossID.BOSS_HAC7);
            this.createBoss(BossID.BOSS_TET);
            this.createBoss(BossID.BOSS_TET2);
            this.createBoss(BossID.BOSS_TET3);
            this.createBoss(BossID.BOSS_TET4);
            this.createBoss(BossID.BOSS_MA);
            this.createBoss(BossID.BOSS_THAN);
            ///
            this.createBoss(BossID.BOSS_TET5);
            this.createBoss(BossID.BOSS_TET6);
            this.createBoss(BossID.BOSS_TET7);
            this.createBoss(BossID.BOSS_TET8);
            this.createBoss(BossID.BOSS_TET9);
            this.createBoss(BossID.BOSS_TET10);
            this.createBoss(BossID.BOSS_TET11);
            this.createBoss(BossID.GOKU_ROSE_N);
            this.createBoss(BossID.GOKU_ROSE_R);
            this.createBoss(BossID.GOKU_ROSE_S);
            this.createBoss(BossID.GOKU_ROSE_NT);
            this.createBoss(BossID.UCHIHA_S);
            this.createBoss(BossID.UCHIHA_SS);
            this.createBoss(BossID.UCHIHA_SSS);
            this.createBoss(BossID.UCHIHA_TT);
            this.createBoss(BossID.BOSS_VANG);
            this.createBoss(BossID.BOSS_NGOC);
            this.createBoss(BossID.BOSS_VANG1);
            ...
            this.createBoss(BossID.BOSS_ZENO3);
            this.createBoss(BossID.BOSS_ZENO3);
...
//                    return new AnTrom();
                ...
                case BossID.BOSS_ADMIN:
                    return new BossADMIN();
                case BossID.BOSS_ADMIN2:
                    return new BossADMIN2();
                case BossID.BOSS_ADMIN3:
                    return new BossADMIN3();
                case BossID.BOSS_ADMIN4:
                    return new BossADMIN4();
                case BossID.BOSS_ADMIN5:
                    return new BossADMIN5();
                case BossID.BOSS_NOEL:
                    return new BossNOEL();
                case BossID.BOSS_TG:
                    return new BossTG();
                case BossID.BOSS_MOI1:
                    return new BossMOI1();
                case BossID.BOSS_MOI2:
                    return new BossMOI2();
                case BossID.BOSS_MOI3:
                    return new BossMOI3();
                case BossID.BOSS_MOI4:
                    return new BossMOI4();
                case BossID.BOSS_MOI5:
                    return new BossMOI5();
                case BossID.BOSS_MOI6:
                    return new BossMOI6();
                case BossID.BOSS_MOI7:
                    return new BossMOI7();
                case BossID.BOSS_MOI8:
                    return new BossMOI8();
                case BossID.BOSS_MOI9:
                    return new BossMOI9();
                case BossID.BOSS_MOI10:
                    return new BossMOI10();
                case BossID.BOSS_HAC:
                    return new BossHAC();
                case BossID.BOSS_HAC1:
                    return new BossHAC1();
                case BossID.BOSS_HAC2:
                    return new BossHAC2();
                case BossID.BOSS_HAC3:
                    return new BossHAC3();
                case BossID.BOSS_HAC4:
                    return new BossHAC4();
                case BossID.BOSS_HAC5:
                    return new BossHAC5();
                case BossID.BOSS_HAC6:
                    return new BossHAC6();
                case BossID.BOSS_HAC7:
                    return new BossHAC7();
                case BossID.BOSS_TET:
                    return new BossTET();
                case BossID.BOSS_TET2:
                    return new BossTET2();
                case BossID.BOSS_TET3:
                    return new BossTET3();
                case BossID.BOSS_TET4:
                    return new BossTET4();
                case BossID.BOSS_MA:
                    return new BossMA();
                case BossID.BOSS_THAN:
                    return new BossTHAN();
                //
                case BossID.BOSS_TET5:
                    return new BossTET5();
                case BossID.BOSS_TET6:
                    return new BossTET6();
                case BossID.BOSS_TET7:
                    return new BossTET7();
                case BossID.BOSS_TET8:
                    return new BossTET8();
                case BossID.BOSS_TET9:
                    return new BossTET9();
                case BossID.BOSS_TET10:
                    return new BossTET10();
                case BossID.BOSS_TET11:
                    return new BossTET11();
                case BossID.GOKU_ROSE_N:
                    return new BossCU();
                case BossID.GOKU_ROSE_R:
                    return new BossCU2();
                case BossID.GOKU_ROSE_S:
                    return new BossCU3();
                case BossID.GOKU_ROSE_NT:
                    return new BossCU4();
                case BossID.UCHIHA_S:
                    return new BossCU5();
                case BossID.UCHIHA_SS:
                    return new BossCU6();
                case BossID.UCHIHA_SSS:
                    return new BossCU7();
                case BossID.UCHIHA_TT:
                    return new BossCU8();
                case BossID.BOSS_VANG:
                    return new BossVANG();
                case BossID.BOSS_NGOC:
                    return new BossNGOC();
                case BossID.BOSS_VANG1:
                    return new BossVANG1();
                case BossID.BOSS_NGOC1:
                ...
                case BossID.BOSS_ZENO:
                    return new BossZeno();
                case BossID.BOSS_ZENO2:
                    return new BossZeno2();
                case BossID.BOSS_ZENO3:
...
//                    return new Mabu();
                ...
                case BossID.BROLY:
                    return new Broly();
                case BossID.LUFFY_GEAR_FIVE_FIGHT_KAIDO:
                    return new LuffyGearFiveFightKaido();
                case BossID.KAIDO:
                    return new Kaido();
                case BossID.LUFFY:
                    return new LuffyNormal();
                case BossID.RORONOA_ZORO:
                    return new Zoro();
                case BossID.VINSMOKE_SANJI:
                    return new Sanji();
                case BossID.NICO_ROBIN:
                    return new NicoRobin();
                case BossID.FRANKY:
                    return new Franky();
                case BossID.BROOK:
                    return new Brook();
                ...
                case BossID.MA_TROI_PINK:
                    return new MaTroiHong();
                case BossID.MA_TROI_BLUE:
                    return new MaTroiXanh();
                default:
                    return null;
            }
        } catch (Exception e) {
//                System.out.println("        loi boss");
    ...
    public void showListBoss(Player player) {
        ...
        try {
            ...
            msg.writer().writeByte((int) bosses.stream().filter(boss
                    ...
                    && !(boss instanceof MiNuong) && !(boss instanceof PetLan)
    ...
    private boolean filterBossInMayDo(long idBoss) {
        return idBoss != BossID.BOSS_ADMIN
                || idBoss != BossID.BOSS_ADMIN5
                || idBoss != BossID.BOSS_ADMIN2
                || idBoss != BossID.BOSS_ADMIN3
                || idBoss != BossID.BOSS_ADMIN4;
    }
    //code by Việt Nguyễn
        ...
        while (ServerManager.isRunning) {
            try {
                ...
                for (Boss boss : this.bosses) {
                    long stNow = System.currentTimeMillis();
                    nameBoss = boss.name;
                    try {
                        boss.update();
                        long checkTime = System.currentTimeMillis() - stNow;
                        if (checkTime > 5000) {
                            System.err.println("Err: lỗi delay update tại boss " + boss.name + " với thời gian delay " + checkTime);
                        }
                    } catch (Exception e) {
                        if (nameBoss != null) {
                            Logger.logException(BossManager.class, e, "Loi UDB " + nameBoss);
                        }
                    }
                }
                long delayTime = 150 - (System.currentTimeMillis() - st);
                if (delayTime > 0) {
