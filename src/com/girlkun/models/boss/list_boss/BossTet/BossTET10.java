 ...
 * @@Edit by ndq
 */
public class BossTET10 extends Boss {

    public BossTET10() throws Exception {
        super(BossID.BOSS_TET10, BossesData.BOSS_TET10);
    }
    ...
    public void reward(Player plKill) {
        ...
        ItemMap it = new ItemMap(this.zone, 753, 3, this.location.x, this.zone.map.yPhysicInTop(this.location.x,
