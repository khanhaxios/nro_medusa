    ...
    public String getHieuQuaLinhCan() {
        ...
        switch (linhCanType) {
            ...
            case 1:
                ...
                break;
            case 2:
                text = String.format("Tăng %s né tránh và %s phản sát thương\nĐòn đánh thường gây Sát thương bằng %s KI", thuocTinhLinhCan.getParam() / 5 + "%", thuocTinhLinhCan.getParam() / 5 + "%", thuocTinhLinhCan.getParam() + 100 * (tuTien.congPhap.phamchat.id + 1 + tuTien.xParam) + "%");
                break;
            case 3:
