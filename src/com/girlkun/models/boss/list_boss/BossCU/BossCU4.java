 ...
 * @@Edit by ndq
 */
public class BossCU4 extends Boss {

    public BossCU4() throws Exception {
        super(BossID.GOKU_ROSE_NT, BossesData.GOKU_ROSE_NT);
    }
    ...
    public void reward(Player plKill) {
        ...
        ItemMap it = new ItemMap(this.zone, 1428, 50000, this.location.x, this.zone.map.yPhysicInTop(this.location.x,
