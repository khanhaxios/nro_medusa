...
public class ItemTimeService {
    ...
    public void sendAllItemTime(Player player) {
        ...
        if (player.itemTimesieucap.isBienhinh) {
            sendItemTime(player, 22071, (int) ((TIME_ITEM3 - (System.currentTimeMillis() - player.itemTimesieucap.lastTimeBienhinh)) / 1000));
        }
        if (player.itemTimesieucap.isBienhinh1) {
            sendItemTime(player, 18290, (int) ((TIME_ITEM3 - (System.currentTimeMillis() - player.itemTimesieucap.lastTimeBienhinh1)) / 1000));
        }
    }
