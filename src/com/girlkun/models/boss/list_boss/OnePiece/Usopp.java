 ...
 */
public class Usopp extends Boss {

    public Usopp() throws Exception {
        super(BossID.USOPP, BossesData.USOPP);
    }
    ...
    public void wakeupAnotherBossWhenDisappear() {
        ...
        int idx = 0;
        boolean chopperDie = false;
        for (Boss boss : this.parentBoss.bossAppearTogether[this.parentBoss.currentLevel]) {
            if (boss.id == BossID.CHOPPER && boss.isDie()) {
                chopperDie = true;
                break;
            }
        }
