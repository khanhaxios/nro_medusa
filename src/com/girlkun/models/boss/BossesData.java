...
//**************************************************************************
    ...
    public static final BossData DORAEMON = new BossData(
            ...
            (byte) 5,
            (byte) 10//boss join map together
    );
    ...
    public static final BossData ZAMAS = new BossData(
            ...
            new int[][]{
                    ...
                    {Skill.TAI_TAO_NANG_LUONG, 2, 50_000},
    ...
    public static final BossData BOSS_HAC = new BossData(
            ...
            10000000, //dame
            new double[]{1000D}, //hp
            new int[]{1, 2, 8, 9, 15, 16}, //map join
            new int[][]{
    ...
    public static final BossData BOSS_LAN = new BossData(
            "Con Lân Hư Hỏng", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1517, 1518, 1519, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            1000000, //dame
            new double[]{1000}, //hp
            new int[]{1, 7, 14}, //map join
            new int[][]{
                    {Skill.KAMEJOKO, 7, 100000},
                    {Skill.DICH_CHUYEN_TUC_THOI, 1, 30000},
                    {Skill.TAI_TAO_NANG_LUONG, 7, 50000},
    ...
    public static final BossData GOKU_ROSE_S = new BossData(
            ...
            new short[]{1484, 1485, 1486, -1, 16, -1}, //outfit {head, body, leg, bag, aura, eff}
            1000000, //dame
            new double[]{300_000_000_000D}, //hp
            new int[]{20}, //map join
            new int[][]{
                    {Skill.KAMEJOKO, 7, 100000},
                    {Skill.DICH_CHUYEN_TUC_THOI, 1, 30000},
    ...
    public static final BossData BOSS_JIREN = new BossData(
            ...
            2000000, //dame
            new double[]{1000_000_000_000D}, //hp
            new int[]{1}, //map join
            new int[][]{
                    {Skill.KAMEJOKO, 7, 100000},
                    {Skill.DICH_CHUYEN_TUC_THOI, 1, 30000},
    ...
    public static final BossData BOSS_JIREN2 = new BossData(
            "Jiren Siêu Cấp", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1234, 1235, 1236, 105, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            2000000, //dame
            new double[]{2000_000_000_000D}, //hp
            new int[]{1}, //map join
            new int[][]{
                    {Skill.KAMEJOKO, 7, 100000},
                    {Skill.DICH_CHUYEN_TUC_THOI, 1, 30000},
    ...
    public static final BossData BOSS_GOKU_UI = new BossData(
            ...
            3000000, //dame
            new double[]{5000_000_000_000D}, //hp
            new int[]{42}, //map join
            new int[][]{
                    {Skill.KAMEJOKO, 7, 100000},
                    {Skill.DICH_CHUYEN_TUC_THOI, 1, 30000},
    ...
    public static final BossData BOSS_GOKU_UI_2 = new BossData(
            "Goku Ultra Instinct", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1527, 1528, 1529, -1, 12, -1}, //outfit {head, body, leg, bag, aura, eff}
            3000000, //dame
            new double[]{10000_000_000_000D}, //hp
            new int[]{42}, //map join
            new int[][]{
                    {Skill.KAMEJOKO, 7, 100000},
                    {Skill.DICH_CHUYEN_TUC_THOI, 1, 30000},
    ...
    public static final BossData BOSS_CAPYPARA = new BossData(
            ...
            3000000, //dame
            new double[]{50000_000_000_000D}, //hp
            new int[]{42}, //map join
            new int[][]{
                    {Skill.KAMEJOKO, 7, 100000},
                    {Skill.DICH_CHUYEN_TUC_THOI, 1, 30000},
    ...
    public static final BossData LIU_LIU = BossData.builder()
            ...
            .skillTemp(new int[][]{
                    {Skill.DRAGON, 1, 100}, {Skill.DRAGON, 2, 200}, {Skill.DRAGON, 3, 300}, {Skill.DRAGON, 7, 700},
                    {Skill.KAMEJOKO, 1, 1000}, {Skill.KAMEJOKO, 2, 1200}, {Skill.KAMEJOKO, 5, 1500}, {Skill.KAMEJOKO, 7, 1700},
                    {Skill.GALICK, 1, 100}, {Skill.TAI_TAO_NANG_LUONG, 1, 50000}
            })
            .secondsRest(REST_5_S)
            .build();
    ...
    public static final BossData LUFFY_GEAR_FIVE = new BossData(
            ...
            80000000, //dame
            new double[]{100_000_000_000L}, //hp
    ...
    public static final BossData LUFFY = new BossData(
            ...
            50000000, //dame
            new double[]{200_000_000_000L}, //hp
            new int[]{182}, //map join
            new int[][]{
