...
public class AnTrom extends Boss {
    ...
    public Player getPlayerAttack() {
        if (this.playerr == this.pet || this.playerr == this.TrieuHoipet || this.playerTarger == this.newpet || Util.canDoWithTime(this.lastTimePlayer, this.timePlayer)) {
            this.playerr = this.zone.getRandomPlayerInMapPlayer();
            this.lastTimePlayer = System.currentTimeMillis();
            this.timePlayer = Util.nextInt(1000, 2000);
        }
        return this.playerr;
    }
