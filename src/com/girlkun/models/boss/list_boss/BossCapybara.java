...
public class BossCapybara extends Boss {
    ...
    public void reward(Player plKill) {
        ...
        if (Util.isTrue(ratio, 100)) {
            ...
            capybara.options.add(new Item.ItemOption(50, Util.nextInt(ratio * 20, ratio * 60)));
            capybara.options.add(new Item.ItemOption(30, 1));
            capybara.options.add(new Item.ItemOption(93, Util.nextInt(1, 3)));
    ...
    public void update() {
        ...
        if ((this.bossStatus == BossStatus.CHAT_S || this.bossStatus == BossStatus.ACTIVE) && Util.canDoWithTime(st, 2700000)) {
