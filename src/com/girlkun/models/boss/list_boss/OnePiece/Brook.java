 ...
 */
public class Brook extends Boss {

    public Brook() throws Exception {
        super(BossID.BROOK, BossesData.BROOK);
    }
    ...
    public void reward(Player plKill) {
        ...
        if (rand > 95) {
            ...
            switch (itemDos[randomDo]) {
                case 1474:
                    itemReward.options.add(new Item.ItemOption(50, Util.nextInt(50, 3)));
                    break;
                case 1475:
                    itemReward.options.add(new Item.ItemOption(77, Util.nextInt(50, 5)));
                    break;
                case 1476:
                    itemReward.options.add(new Item.ItemOption(103, Util.nextInt(50, 5)));
                    break;
            }
        }
    ...
    public void wakeupAnotherBossWhenDisappear() {
        ...
        for (Boss boss : this.parentBoss.bossAppearTogether[this.parentBoss.currentLevel]) {
            if (boss.id == BossID.FRANKY && !boss.isDie()) {
                boss.actFight = true;
                boss.chat("Cậu người xương lùi lại, để ta đánh với hắn!");
                return;
            }
        }
