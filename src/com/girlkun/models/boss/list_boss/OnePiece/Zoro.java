 ...
 */
public class Zoro extends Boss {

    public Zoro() throws Exception {
        super(BossID.RORONOA_ZORO, BossesData.RORONOA_ZORO);
    }

    @Override
    public void reward(Player plKill) {
        int[] itemDos = new int[]{2033};
