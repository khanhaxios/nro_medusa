...
//                            Service.getInstance().sendThongBao(player, "Chức năng đang bảo trì");
                    ...
                    case ConstNpc.MENU_OPTION_USE_ITEM1524:
                        ...
                        switch (select) {
                            case 0 ->
                                ItemService.gI().openSKHJiren(player, 235);
                            case 1 ->
                                ItemService.gI().openSKHJiren(player, 236);
                            case 2 ->
                                ItemService.gI().openSKHJiren(player, 237);
                            default -> {
                            }
                        }
                    } catch (Exception e) {
                    ...
                    case ConstNpc.MENU_OPTION_USE_ITEM1532:
                        ...
                        switch (select) {
                            case 0 ->
                                ItemService.gI().openSKHGokuUI(player, 241);
                            case 1 ->
                                ItemService.gI().openSKHGokuUI(player, 242);
                            case 2 ->
                                ItemService.gI().openSKHGokuUI(player, 243);
                            default -> {
                            }
                        }
                    } catch (Exception e) {
...
//                                PlayerService.gI().baoTri();
                    ...
                    case ConstNpc.INFO_DAO_LU:
                        switch (select) {
                            ...
                            case 1 ->
                                player.petDaoLu.changeStatus(DaoLu.ATTACK);
                            case 2 ->
                                player.petDaoLu.changeStatus(DaoLu.FOLLOW);
                            case 3 ->
                                player.petDaoLu.changeStatus(DaoLu.GOHOME);
                            case 4 -> {
