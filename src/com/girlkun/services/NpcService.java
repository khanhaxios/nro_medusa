...
public class NpcService {
    ...
    public void createMenuSieuCap(Player player, int indexMenu, String npcSay, String... menuSelect) {
        createMenu(player, indexMenu, ConstNpc.RONG_SIEU_CAP, 124, npcSay, menuSelect);
    }
