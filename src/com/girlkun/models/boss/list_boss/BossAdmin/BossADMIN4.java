 ...
 * @@Edit by ndq
 */
public class BossADMIN4 extends Boss {

    public BossADMIN4() throws Exception {
        super(BossID.BOSS_ADMIN4, BossesData.BOSS_ADMIN4);
    }
...
//        Service.getInstance().dropItemMap(this.zone, dayThung);
        ...
        int a = 0;
        for (int i = 0; i < 8; i++) {
            ItemMap it1 = new ItemMap(this.zone, 1339, 10, this.location.x + a, this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), plKill.id);
