...
public class DataGame {
    ...
    public static String LINK_IP_PORT = "Girlkun75-1:14.225.219.176:14445:0";
        ...
        try {
            ...
            for (NClass nClass : Manager.NCLASS) {
                ...
                for (SkillTemplate skillTemp : nClass.skillTemplatess) {
                    ...
                    msg.writer().writeUTF("MEDUSA Vạn Tế = ))");
                    if (skillTemp.id != 0) {
...
//            Logger.logException(DataGame.class, e);
            System.out.println("Session IP " + session.ipAddress + " load ItemBGTemplate bất hợp lệ -> id " + id);
        }
    }
