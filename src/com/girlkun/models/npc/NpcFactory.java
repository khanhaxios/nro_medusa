...
import com.girlkun.models.lucky_pool.LuckyPool;
...
import com.girlkun.models.sangiaodich.danduoc.SanGiaoDichDanDuoc;
...
//                                        throw new RuntimeException(e);
                                ...
                                if (honLinhThu == null || honLinhThu.quantity < 99) {
                                    ...
                                    trungLinhThu.itemOptions.add(new ItemOption(30, 1));
...
//                                    player.inventory.skMedusa += 10_000_000;
                                    ...
                                    phieugg.itemOptions.add(new ItemOption(30, 1));
                                    ...
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    this.npcChat(player, "|4|Bạn nhận được 200 " + manhthiensu.template.name + ",1 hộp Nguyên Thủy, 30 hộp quà tết, 50 Hộp quà Hỗ trợ MEDUSA,  30 Thẻ gia hạn, 198 Hư vô thần chiến đao và 5M Hồng ngọc");
                                }
                                break;
                            }
                            //
...
//                                    player.inventory.skMedusa += 10_000;
                                    ...
                                    InventoryServiceNew.gI().addItemBag(player, thegh);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    this.npcChat(player, "|4|Bạn nhận được 200 " + manhthiensu.template.name + ",1 hộp thánh tôn găng 20k, 30 hộp quà tết, 50 Hộp quà Hỗ trợ MEDUSA,  30 Thẻ gia hạn, 1 Phiếu giảm giá và 2,5M Hồng ngọc");
                                }
                                break;
                            }
                            case 2: {
...
//                                    player.inventory.skMedusa += 5000;
                                    ...
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    this.npcChat(player, "|4|Bạn nhận được 100 " + manhthiensu.template.name + ",1 hộp sên đa hệ, 40 hộp quà Hỗ trợ MEDUSA, 15 hộp quà tết, 10 Thẻ gia hạn và 500k Hồng ngọc");
                                }
                                break;
                            }
                            case 3: {
...
//                                    player.inventory.skMedusa += 200;
                                    ...
                                    InventoryServiceNew.gI().addItemBag(player, thegh);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    this.npcChat(player, "|4|Bạn nhận được 50 " + manhthiensu.template.name + ", 30 hộp quà Hỗ trợ MEDUSA, 10 hộp quà tết, 5 Thẻ gia hạn và 100k Hồng ngọc");
                                }
                                break;
                            }
                            case 4: {
                                ...
                                if (player.NguHanhSonPoint < 50) {
                                    ...
                                    InventoryServiceNew.gI().addItemBag(player, ruongthan);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    this.npcChat(player, "|4|Bạn nhận được 10 " + manhthiensu.template.name + ", 5 hộp quà Hỗ trợ MEDUSA và 25k Hồng ngọc");
                                }
                                break;
                            }
                        }
    ...
    public static Npc nami(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "|1|Oh hoan nghên bạn đến với của hàng của tôi\n bạn có muốn đổi vỏ ốc, cua đỏ\nlấy các món đồ mùa hè không?.", "Cửa hàng\nNami");
                    }
                }
            }
    ...
    public static Npc roronoaZoro(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 183) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "|1|Ngươi muốn quay về Đảo Skypie không?," + "\nở đây rất nguy hiểm vì thuyền trưởng của ta đang đánh nhau với Kaido" + "\nĐể ta đưa ngươi về đảo!", "Về thôi", "Từ chối");
                    } else {
                        this.createOtherMenu(player, 1, "|1|Đừng có làm phiền ta ngủ trưa!", "Rời Khỏi");
                    }
                }
            }
    ...
    public static Npc franky(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 179) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "|1|Cậu muốn đến đầu trường Skypiea không, nghe nói Luffy đang đấm nhau với Kaido tại đấy.", "Lên đường", "Từ chối");
                    }
                    if (this.mapId == 183) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "|1|Cậu muốn quay về Đảo Skypie?,\nđể Franky tôi đưa cậu về", "Về thôi", "Từ chối");
                    }
                }
            }
                            ...
                            switch (select) {
                                ...
                                case 5: {
                                    ...
                                    if (InventoryServiceNew.gI().getCountEmptyBag(player) < 7) {
                                        ...
                                        spl.itemOptions.add(new ItemOption(95, 5));
                                        spl1.itemOptions.add(new ItemOption(96, 5));
                                        spl2.itemOptions.add(new ItemOption(97, 5));
                                        spl3.itemOptions.add(new ItemOption(98, 5));
                                        spl4.itemOptions.add(new ItemOption(99, 5));
                                        spl5.itemOptions.add(new ItemOption(100, 5));
                                        spl6.itemOptions.add(new ItemOption(101, 5));
...
//                                        throw new RuntimeException(e);
                                    ...
                                    if (honLinhThu == null || honLinhThu1 == null || honLinhThu2 == null || honLinhThu3 == null || honLinhThu.quantity < 99 || honLinhThu1.quantity < 99 || honLinhThu2.quantity < 99 || honLinhThu3.quantity < 99) {
                                        ...
                                        trungLinhThu.itemOptions.add(new ItemOption(50, 30));
                                        trungLinhThu.itemOptions.add(new ItemOption(77, 20));
                                        trungLinhThu.itemOptions.add(new ItemOption(101, 400));
                                        trungLinhThu.itemOptions.add(new ItemOption(30, 1));
                                        InventoryServiceNew.gI().addItemBag(player, trungLinhThu);
                                        InventoryServiceNew.gI().sendItemBags(player);
...
//                                        throw new RuntimeException(e);
                                    ...
                                    if (honLinhThu == null || honLinhThu.quantity < 99) {
                                        ...
                                        trungLinhThu.itemOptions.add(new ItemOption(50, 60));
                                        trungLinhThu.itemOptions.add(new ItemOption(77, 40));
                                        trungLinhThu.itemOptions.add(new ItemOption(103, 40));
                                        trungLinhThu.itemOptions.add(new ItemOption(101, 1000));
                                        trungLinhThu.itemOptions.add(new ItemOption(93, 1));
                                        trungLinhThu.itemOptions.add(new ItemOption(30, 1));
                                        InventoryServiceNew.gI().addItemBag(player, trungLinhThu);
                                        InventoryServiceNew.gI().sendItemBags(player);
...
//                                        throw new RuntimeException(e);
                                    ...
                                    if (honLinhThu == null || honLinhThu.quantity < 99) {
                                        ...
                                        trungLinhThu.itemOptions.add(new ItemOption(77, 40));
                                        trungLinhThu.itemOptions.add(new ItemOption(103, 40));
                                        trungLinhThu.itemOptions.add(new ItemOption(95, 5));
                                        trungLinhThu.itemOptions.add(new ItemOption(96, 5));
                                        trungLinhThu.itemOptions.add(new ItemOption(101, 1000));
                                        trungLinhThu.itemOptions.add(new ItemOption(30, 1));
                                        InventoryServiceNew.gI().addItemBag(player, trungLinhThu);
                                        InventoryServiceNew.gI().sendItemBags(player);
                ...
                if (canOpenNpc(player)) {
                    if (player.iDMark.getIndexMenu() == ConstNpc.MENU_NPC_TU_TIEN) {
                        switch (select) {
                            ...
                            case 5:
                                // the chat
                                createOtherMenu(player, ConstNpc.THE_CHAT, "Thể chất là một phần mạnh mẽ trong hệ thống tu luyện", "Kích hoạt", "Từ chối");
                                break;
                            case 6:
                    ...
                    } else if (player.iDMark.getIndexMenu() == ConstNpc.THE_CHAT) {
                        if (select == 0) {
                            player.theChat = player.theChat.kichHoat();
                            if (player.theChat != null) {
                                Service.gI().point(player);
                                Service.gI().sendThongBaoOK(player, "Kích hoạt thể chất thành công");
                            }
                        }
                        ...
                        if (select == 0) {// hoc tien phap yeu cau canh gioi hoa than tro len
                        ...
                        if (select == 0) {//  hoc tien phap ngau nhien theo thuoc tinh linh can
                        }
                    }
                }
            }
                ...
                if (player.iDMark.getIndexMenu() == ConstNpc.BASE_MENU) {
                    switch (select) {
                        ...
                        case 1:
                            ...
                            if (player.tuMa.isTuMa() && player.tuMa.congPhapTuMa.tenCongPhap != null) {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            if (player.tuMa.level / 10 < 8) {
                                Service.gI().sendThongBaoOK(player, "Cần đạt tu ma cảnh giới " + TuMa.CANH_GIOI[8] + " để luyện cốt");
                                return;
                            }
                            if (player.session.vnd - 300_000 < 0) {
                                Service.gI().sendThongBaoOK(player, "Cần đạt 300k điểm nạp để mở luyện cốt");
                            }
                            PlayerDAO.subvnd(player, 300_000);
                            player.tuMa.luyenCot.openSystem();
                            break;
                        case 5:
                            createOtherMenu(player, ConstNpc.THE_CHAT, "Thể chất giúp mày nhanh mạnh hơn", "Kích hoạt", "Từ chối");
                            break;
                        case 6:
                            player.tuMa.reset();
                            break;
                    ...
                    if (select == 0) {
                        ...
                        if (player.theChat != null) {
                            Service.gI().point(player);
                            Service.gI().sendThongBao(player, "Kích hoạt thể chất thành công");
                        }
                    }
                } else if (player.iDMark.getIndexMenu() == ConstNpc.MENU_KH_HM) {
                    switch (select) {
                ...
                if (player.iDMark.getIndexMenu() == ConstNpc.MENU_NPC_LUYEN_THE) {
                    switch (select) {
                        ...
                        case 4:
                            ...
                            break;
                        case 5:
                            this.createOtherMenu(player, ConstNpc.THE_CHAT, "Thể chất giúp bạn mạnh hơn rất nhiều", "Kích hoạt", "Từ chối");
                            break;
                        case 6:
                    ...
                    if (select == 0) {
                        ...
                        player.luyenThe.congPhapLuyenThe.hocCongPhap();
                    }
                } else if (player.iDMark.getIndexMenu() == ConstNpc.MENU_KH_HM) {
                    switch (select) {
                        case 0 -> player.huyet.kichHoatHuyetMach();
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void confirmMenu(Player player, int select) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 140) {
                        if (player.iDMark.isBaseMenu()) {
                            if (select == 0) {//                                    Service.getInstance().sendThongBao(player, "Chức năng đang bảo trì");
...
//                                this.createOtherMenu(player, ConstNpc.QUY_DOI_BUA_ZENO, "|7|QUY ĐỔI BÙA ZENO\n|6|Quy đổi Bùa Zeno\n\n|1|Tiền hiện còn : " + " " + Util.format(player.getSession().vnd) + "\n\n" + String.format("|5|Giá %s Điểm 1 Bùa Zeno\n\n Con muốn đổi bao nhiêu?", Util.format(Manager.GIA_QUY_DOI_BUA_ZENO)), "1 bùa", "10 bùa", "100 bùa", "1000 bùa", "Đổi tất\ncả", "Từ chối");
                        ...
                        double totalMoneyNeed = totalZeno * Manager.GIA_QUY_DOI_BUA_ZENO;
                        ...
                        InventoryServiceNew.gI().sendItemBags(player);
                        Service.gI().sendThongBao(player, "Đổi thành công " + totalZeno + " bùa zeno");
                    ...
                    switch (select) {
                        case 0:
                            if (!player.gift.gemTanThu) {
                                ...
                                this.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Con đã nhận phần quà này rồi mà", "Đóng");
                            }
                            break;
//                            case 1:
//                                if (nhanVang) {
                                ...
                                case 0:
                                    ...
                                    if (boss != null && !boss.isDie()) {
                                        if (player.inventory.gold >= COST_FIND_BOSS) {
                                            ...
                                            Service.getInstance().sendThongBao(player, "Không đủ vàng, còn thiếu " + Util.numberToMoney(COST_FIND_BOSS - player.inventory.gold) + " vàng");
                                        }
                                        break;
                                    }
...
//                            "UP SK TẾT 2024",
//                            "Đổi Hộp Quà Medusa");
                    createOtherMenu(player, ConstNpc.BASE_MENU, "|7|Sự Kiện Trung Thu - Đấm Boss Kịch Sàn\n" + "Sự kiện đang diễn ra tại npc Mị Nương\n" + "Tích cực đấm boss để săn vật phẩm sự kiện\n" + "Sự kiện dành cho người cày chay\n" + "Muốn leo nhanh thì tới đây mua vật phẩm!", "Cửa hàng Sự Kiện", "UP SK NOEL", "UP SK TẾT 2024", "Đổi Hộp Quà Medusa");
//                    createOtherMenu(player, ConstNpc.BASE_MENU,
//                            "|7|Sự Kiện 2 Tháng 9\n"
                        ...
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                ...
                                case 3:
                                    ...
                                    hopquaMedusa.itemOptions.add(new ItemOption(230, 1));
...
//                                    break;
    ...
    public static Npc GOKU_TET(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    createOtherMenu(player, ConstNpc.BASE_MENU, "Đừng dạy người giàu cách tiêu tiền ", "Cửa hàng super VIP", "Kame Island");
                }
            }
...
//                                    break;
    ...
    public static Npc cayneu(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    createOtherMenu(player, ConstNpc.BASE_MENU, "Map up nguyên liệu tết cho VIP", "MAP VIP 1", "MAP VIP 2", "Titan SSS", "Cold SSS", "Steal SSS", "Dung Nham SSS", "Death Sahara SSS", "Plant SSS", "Fire Hole SSS", "Địa Ngục chết chóc SSS", "Hồn quê SSS");
                }
            }
                    ...
                    if (this.mapId == 5 || this.mapId == 69 || this.mapId == 20) {
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                case 0: //doi moii
                                    if (player.haveTuTien) {
                                        if (player.setClothes.NhanHoang == 5 || player.setClothes.MaThan == 5 || player.setClothes.ThienTu == 5 || player.setClothes.isSetThongKho() || player.setClothes.isSetJiren() || player.setClothes.isSetGokuUI() || player.isAdmin()) {
                        ...
                        switch (select) {
                            case 0://xu ly gap thường
                                ...
                                if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
                                    ...
                                    linhThu.itemOptions.add(new ItemOption(50, Util.nextInt(30, 90)));
                                    linhThu.itemOptions.add(new ItemOption(77, Util.nextInt(30, 90)));
                                    linhThu.itemOptions.add(new ItemOption(103, Util.nextInt(30, 90)));
                            ...
                            case 1://xu ly gap VIP
                                ...
                                if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
                                    ...
                                    if (Util.isTrue(1, 100)) {//60% gap ra linh thú
                                        ...
                                        chanMenhC10.itemOptions.add(new ItemOption(230, 1));
                                        chanMenhC10.itemOptions.add(new ItemOption(50, Util.nextInt(1000, 2000)));
                                        chanMenhC10.itemOptions.add(new ItemOption(247, 1));
                                        chanMenhC10.itemOptions.add(new ItemOption(30, 0));
                                        if (Util.isTrue(40, 100)) {//tile 40% add thêm 100-500% tnsm (id tnsm 101)
                                            chanMenhC10.itemOptions.add(new ItemOption(101, Util.nextInt(1000, 5000)));
                                        }
                                        ...
                                        linhThu.itemOptions.add(new ItemOption(50, Util.nextInt(50, 95)));
                                        linhThu.itemOptions.add(new ItemOption(77, Util.nextInt(50, 95)));
                                        linhThu.itemOptions.add(new ItemOption(103, Util.nextInt(50, 95)));
                                        linhThu.itemOptions.add(new ItemOption(30, 0));
                                        if (Util.isTrue(40, 100)) {//tile 40% add thêm 100-500% tnsm (id tnsm 101)
                                            linhThu.itemOptions.add(new ItemOption(101, Util.nextInt(1000, 5000)));
                                        }
                                        InventoryServiceNew.gI().addItemBag(player, linhThu);
                                        ...
                                        if (rac[randomRac] == 938) {//938 là ctrang cc j đó
                                            ...
                                            ctrang938.itemOptions.add(new ItemOption(50, Util.nextInt(100, 150)));//add chiso sdanh (50) từ 30-100% random
                                            ctrang938.itemOptions.add(new ItemOption(77, Util.nextInt(100, 150)));
                                            ctrang938.itemOptions.add(new ItemOption(103, Util.nextInt(100, 150)));
                                            ctrang938.itemOptions.add(new ItemOption(101, Util.nextInt(2000, 5000)));//add chiso sdanh (50) từ 30-100% random
                                            ctrang938.itemOptions.add(new ItemOption(95, Util.nextInt(20, 30)));
                                            ctrang938.itemOptions.add(new ItemOption(96, Util.nextInt(20, 30)));
                                            ctrang938.itemOptions.add(new ItemOption(33, 0));
                                            ctrang938.itemOptions.add(new ItemOption(116, 0));
                                            ctrang938.itemOptions.add(new ItemOption(106, 0));
                                            ctrang938.itemOptions.add(new ItemOption(30, 0));
                                            ...
                                            detu.itemOptions.add(new ItemOption(30, 1));
                            ...
                            switch (select) {
                                case 0:
                                    ...
                                    if (bossLan != null) {
                                        ...
                                        BossData bossDataClone = new BossData("Lân được " + player.name + " hộ tống", (byte) 2, new short[]{1517, 1518, 1519, -1, -1, -1}, 100000, new double[]{player.nPoint.dame * 2}, new int[]{103}, new int[][]{{Skill.TAI_TAO_NANG_LUONG, 7, 15000}}, new String[]{}, //text chat 1
                                ...
                                case 1:
                                    ...
                                    if (rand > 90) {
                                        ...
                                        rongLanPhunLua.itemOptions.add(new ItemOption(230, 1));
                                        rongLanPhunLua.itemOptions.add(new ItemOption(50, Util.nextInt(1000, 5000)));
                                        rongLanPhunLua.itemOptions.add(new ItemOption(77, Util.nextInt(1000, 10000)));
                                        rongLanPhunLua.itemOptions.add(new ItemOption(103, Util.nextInt(1000, 10000)));
                                        rongLanPhunLua.itemOptions.add(new ItemOption(95, Util.nextInt(100, 200)));
                                        rongLanPhunLua.itemOptions.add(new ItemOption(96, Util.nextInt(100, 200)));
                                        rongLanPhunLua.itemOptions.add(new ItemOption(14, Util.nextInt(15, 20)));
                                        if (!Util.isTrue(30, 100)) {
                                            rongLanPhunLua.itemOptions.add(new ItemOption(234, Util.nextInt(1, 3)));
                                        }
                                        rongLanPhunLua.itemOptions.add(new ItemOption(30, 1));
                                        ...
                                        Item lvOne = ItemService.gI().createNewItem(itemLvOne[randItem]);
                                        lvOne.itemOptions.add(new ItemOption(230, 1));
                                        lvOne.itemOptions.add(new ItemOption(30, 1));
                                        ...
                                        Item lvTwo = ItemService.gI().createNewItem(racLvTwo[randItem]);
                                        lvTwo.itemOptions.add(new ItemOption(230, 1));
                                        lvTwo.itemOptions.add(new ItemOption(30, 1));
                                ...
                                case 2:
                                    this.createOtherMenu(player, 1, "|2|Gặp Npc Mị Nương: Chọn Hộ Tống Rồi Dắt Bé Quỳnh đến Vị Trí được chỉ định\n" + "Phần quà 30 Thỏi vàng và Random 3-7 Xu hộ tống. " + "Phí hộ tống là 2k Ngọc Hồng" + "\n|7|Mỗi ngày chỉ được Hộ tống tối đa 15 lần" + "\n*Yêu cầu : Đã xong nhiệm vụ Tiểu đội sát thủ", "Hiểu rồi");
                                    break;
                                case 3:
                                    if (TaskService.gI().getIdTask(player) >= ConstTask.TASK_21_0) {
                                        this.createOtherMenu(player, 12345, "|7|HỘ TỐNG BÉ QUỲNH" + "\n\n|1|Bé Quỳnh đang đi lạc ngươi hãy giúp ta đưa nàng đến Đảo Kame \n Ta trao thưởng quà Hậu hĩnh !!" + "\n\n|2|Hôm nay đã hộ tống: " + player.taixiu.hotong + " lần" + "\n|7|Mỗi ngày chỉ được Hộ tống tối đa 15 lần" + "|7|Bạn có muốn dùng 5.000 Hồng ngọc để Hộ tống Bé Quỳnh đến điểm đích để nhận được phần quà hấp dẫn không?", "Đồng ý", "Từ chối");
                                    } else {
                            ...
                            if (select == 0) {
                                if (TaskService.gI().getIdTask(player) >= ConstTask.TASK_20_0) {
                                    ...
                                    if (oldDuongTank != null) {
                                        ...
                                        BossData bossDataClone = new BossData("Bé Quỳnh được " + player.name + " hộ tống", (byte) 2, new short[]{1378, 1379, 1380, -1, -1, -1}, 100000, new double[]{player.nPoint.hpMax * 2}, new int[]{103}, new int[][]{{Skill.TAI_TAO_NANG_LUONG, 7, 15000}}, new String[]{}, //text chat 1
                                                new String[]{}, //text chat 2
                                                new String[]{}, //text chat 3
                                                60);
                                        try {
    ...
    public static Npc thuongDe(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 45) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "Con muốn làm con cặc gì nào", "Đến Kaio", "Phòng tập MEDUSA bảo trì", "Quay số\nmay mắn");
                    }
//                    if (this.mapId == 0) {
...
//                    }
                    if (this.mapId == 129 || this.mapId == 141 || this.mapId == 49) {
                        this.createOtherMenu(player, 0, "Con muốn con cặc gì nào?", "Quay về");
                    }
                }
            }
                        ...
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                ...
                                case 1: //doi map phong tap Medusa
                                    ...
                                    break;
                                case 2:
                                    this.createOtherMenu(player, ConstNpc.MENU_CHOOSE_LUCKY_ROUND, "Con muốn làm gì nào?", "Quay bằng\nvàng", "Quay bằng\n100 bùa\nzeno", "Rương phụ\n(" + (player.inventory.itemsBoxCrackBall.size() - InventoryServiceNew.gI().getCountEmptyListItem(player.inventory.itemsBoxCrackBall)) + " món)", "Xóa hết\ntrong rương", "Đóng");
                                    break;
                            }
                        ...
                        case ConstNpc.CAN_NOT_OPEN_EGG:
                            if (select == 0) {
                                ...
                                if (player.inventory.gold >= COST_AP_TRUNG_NHANH) {
                                    ...
                                    Service.getInstance().sendThongBao(player, "Bạn không đủ vàng để thực hiện, còn thiếu " + Util.numberToMoney((COST_AP_TRUNG_NHANH - player.inventory.gold)) + " vàng");
                                }
                            }
                            break;
                    ...
                    if (player.iDMark.isBaseMenu()) {
                        switch (select) {
                            case 0:
                                if (player.nPoint.limitPower < 9) {
                                    ...
                                    this.createOtherMenu(player, ConstNpc.OPEN_POWER_MYSEFT, "Ta sẽ truền năng lượng giúp con mở giới hạn sức mạnh của bản thân lên " + "10.000 tỷ Sức mạnh", "Nâng ngay\n" + "500.000" + " hồng ngọc", "Đóng");
                            ...
                            case 1:
                                if (player.pet != null) {
                                    if (player.pet.nPoint.limitPower < 9) {
                                        ...
                                        this.createOtherMenu(player, ConstNpc.OPEN_POWER_PET, "Ta sẽ truền năng lượng giúp con mở giới hạn sức mạnh của Đệ tử lên " + "10.000 tỷ Sức mạnh", "Nâng ngay\n" + "500.000" + " hồng ngọc", "Đóng");
                        ...
                        if (select == 0) {
                            if (player.inventory.gold >= OpenPowerService.COST_SPEED_OPEN_LIMIT_POWER) {
                                ...
                                Service.getInstance().sendThongBao(player, "Bạn không đủ vàng để mở, còn thiếu " + Util.numberToMoney((OpenPowerService.COST_SPEED_OPEN_LIMIT_POWER - player.inventory.gold)) + " vàng");
                            }
                        }
                    } else if (player.iDMark.getIndexMenu() == ConstNpc.OPEN_POWER_MYSEFT && player.nPoint.limitPower == 9) {
                        if (select == 0) {
                            if (player.inventory.ruby >= 66000) {
                                ...
                                Service.getInstance().sendThongBao(player, "Bạn không đủ hồng ngọc để mở, còn thiếu " + Util.numberToMoney((66000 - player.inventory.ruby)) + " hồng ngọc");
                            }
                        }
                        ...
                        if (select == 0) {
                            if (player.inventory.ruby >= 120000) {
                                ...
                                Service.getInstance().sendThongBao(player, "Bạn không đủ hồng ngọc để mở, còn thiếu " + Util.numberToMoney((500000 - player.inventory.ruby)) + " hồng ngọc");
                            }
                        }
                        ...
                        if (select == 0) {
                            if (player.inventory.ruby >= 1000000) {
                                ...
                                Service.getInstance().sendThongBao(player, "Bạn không đủ hồng ngọc để mở, còn thiếu " + Util.numberToMoney((1000000 - player.inventory.ruby)) + " hồng ngọc");
                            }
                        }
                        ...
                        if (select == 0) {
                            if (player.inventory.ruby >= 10000000) {
                                ...
                                Service.getInstance().sendThongBao(player, "Bạn không đủ hồng ngọc để mở, còn thiếu " + Util.numberToMoney((100000000 - player.inventory.ruby)) + " hồng ngọc");
                            }
                        }
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    ...
                    } else if (BossManager.gI().existBossOnPlayer(player) || player.zone.items.stream().anyMatch(itemMap -> ItemMapService.gI().isBlackBall(itemMap.itemTemplate.id)) || player.zone.getPlayers().stream().anyMatch(p -> p.iDMark.isHoldBlackBall())) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 47 || this.mapId == 84) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "Xin chào, cậu muốn tôi giúp gì?", "Nhiệm vụ\nhàng ngày", "Nhiệm vụ\n tích lũy", "Danh hiệu", "Sàn DG", "Từ chối");
                    }
//                    if (this.mapId == 47) {
//                        this.createOtherMenu(player, ConstNpc.BASE_MENU,
                            ...
                            switch (select) {
                                case 0:
                                    if (player.playerTask.sideTask.template != null) {
                                        ...
                                        this.createOtherMenu(player, ConstNpc.MENU_OPTION_LEVEL_SIDE_TASK, "Tôi có vài nhiệm vụ theo cấp bậc, " + "sức cậu có thể làm được cái nào?\b|5|Phần thưởng:\b|7| Dễ: 2 Thỏi vàng\n Bình thường: 3 Thỏi vàng\n Khó: 4 Thỏi vàng\n Siêu khó: 5 Thỏi vàng\n Địa ngục: 7 Thỏi vàng", "Dễ", "Bình thường", "Khó", "Siêu khó", "Địa ngục", "Từ chối");
                                    }
                                    break;
                                case 1:
                                    ...
                                    break;
                                case 2:
                                    this.createOtherMenu(player, 888, "|7|CHỨC NĂNG DANH HIỆU" + "\n\n|2|Đây là danh hiệu mà ngươi có" + (player.lastTimeTitle1 > 0 ? "\n\n|4|Danh hiệu Đại Thần: " + Util.msToTime(player.lastTimeTitle1) : "") + (player.lastTimeTitle2 > 0 ? "\n Danh hiệu Trùm Cuối: " + Util.msToTime(player.lastTimeTitle2) : "") + (player.lastTimeTitle3 > 0 ? "\n Danh hiệu Tuổi Thơ: " + Util.msToTime(player.lastTimeTitle3) : ""), ("Đại Thần\n" + (player.isTitleUse1 ? "'ON'" : "'OFF'")), ("Trùm Cuối\n" + (player.isTitleUse2 ? "'ON'" : "'OFF'") + "\n"), ("Tuổi Thơ\n" + (player.isTitleUse3 ? "'ON'" : "'OFF'") + "\n"));
                                    break;
                                case 3:
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 135) {
                        ...
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "Kính chào VIP!", "Cửa hàng", "Quay Số", "Đóng");
                    }
                }
            }
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 102) {
                        if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                            this.createOtherMenu(player, ConstNpc.BASE_MENU, "Cậu bé muốn mua gì nào?", "Linh Thú", "Đóng");
                        }
                    } else if (this.mapId == 46 || this.mapId == 5) {
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "Kính chào VIP!", "Linh Thú", "Đóng");
                    }
                }
            }
...
//                }
                ...
                if (canOpenNpc(player)) {
                    if (this.mapId == 21 || mapId == 22 || mapId == 23 || mapId == 5) {
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                case 0:
                                    createOtherMenu(player, ConstNpc.MENU_PHU_SU, "Học chế bùa cần đạt tu tiên cấp Kim Đan và luyện thể cấp 10 thêm 100k điểm nữa nhé", "Học", "Từ chối");
                                    break;
                                case 1:
    ...
    public static Npc vados(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    createOtherMenu(player, ConstNpc.BASE_MENU, "|7| BẢNG XẾP HẠNG" + "\n|6|Ta Vừa Hack Map xem Được TOP Của Toàn Server" + "\b|1|Người Muốn Xem TOP Gì?", "Top\nTu Tiên", "Top\nTu Ma", "Top\nLuyện Thể", "Đóng");
                }
            }
            ...
            public void confirmMenu(Player player, int select) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 5) {
                        if (player.iDMark.getIndexMenu() == ConstNpc.BASE_MENU) {
                            if (select == 0) {
                                Service.gI().showListTop(player, Manager.topTuTien);
                                return;
                            }
                            if (select == 1) {
                                Service.gI().showListTop(player, Manager.topTuMa);
                                return;
                            }
                            if (select == 2) {
                                Service.gI().showListTop(player, Manager.topLuyenThe);
                            }
                        }
                    }
                }
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 80) {
                        ...
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "Xin chào, tôi có thể giúp gì cho cậu?", "Quay về", "Shop\nTuyệt Kỹ", "Từ chối");
                    } else {
                        super.openBaseMenu(player);
                    }
                }
            ...
            public void confirmMenu(Player player, int select) {
                if (canOpenNpc(player)) {
                    if (mapId == 0 && player.iDMark.getIndexMenu() == ConstNpc.BASE_LKS_MENU) {
                        ...
                        if (select == 0) {// dot pha luyen khi su o day ne
...
//                        }
    ...
    public static void createNpcConMeo() {
        ...
        npc = new Npc(-1, -1, -1, -1, ConstNpc.CON_MEO, 351) {
            ...
            public void confirmMenu(Player player, int select) {
                switch (player.iDMark.getIndexMenu()) {
                    case ConstNpc.MENU_CONFRM_QSMM:
                        int timeaa = 0;
                        if (select == 0) {
                            timeaa = 1;
                        } else if (select == 1) {
                        ...
                        LuckyPool.prepeareForRoll(timeaa, player);
                        break;
                    case ConstNpc.MENU_QSMM:
                        switch (select) {
                            case 0:
                                LuckyPool.showMenuQuaySo(player);
                                break;
                            case 1:
                                LuckyPool.showTuiTamThoi(player);
                                break;
                            case 2:
                                LuckyPool.removeAllItemInBag(player);
                                break;
                        }
                        break;
                    case ConstNpc.MENU_CP_LT_TP:
                        switch (select) {
                            case 0:
                                player.luyenThe.congPhapLuyenThe.nangPham();
                                break;
                            case 1:
                    ...
                    case ConstNpc.MENU_CP_LT:
                        switch (select) {
                            case 0:
                                player.luyenThe.congPhapLuyenThe.showMenuTangCap();
                                break;
                            case 1:
                                player.luyenThe.congPhapLuyenThe.showMenuTangPham();
                                break;
                            case 2:
                                player.luyenThe.congPhapLuyenThe.showMenuThuocTinh();
                                break;

                        }
                        break;
                    case ConstNpc.MENU_TC_CP_LT:
                        switch (select) {
                            case 0:
                    ...
                    case ConstNpc.MENU_TOI_HUYET:
                        ...
                        if (slSuDung > 0) {
                            player.huyet.toiHuyet(slSuDung);
                        }
                        break;
                    case ConstNpc.MENU_TINH_HUYET:
                        int soDanDung = 0;
                        switch (select) {
                            case 0:
                                soDanDung = 1;
                        ...
                        if (soDanDung > 0) {
                            player.huyet.tinhHuyet(soDanDung);
                        }
                        break;
                    case ConstNpc.BASE_MENU_HUYET:
                        switch (select) {
                            case 0:
                                player.huyet.openMenuTinhHuyet();
                                break;
                            case 1:
                                player.huyet.openMenuToihuyet();
                                break;
                            case 2:
                    ...
                    case ConstNpc.CHON_PHAP_BAO_CUONG_HOA:
                        ...
                        InventoryServiceNew.gI().subQuantityItemsBag(player, player.iDMark.itemCuongHoaPhapBao, 1);
                        InventoryServiceNew.gI().sendItemBags(player);
                        break;
                    ...
                    case ConstNpc.MENU_CONG_PHAP_TU_MA:
                        switch (select) {
                            case 0:
                                player.tuMa.congPhapTuMa.showMenuKichHoat();
                                break;
                            case 1:
                                player.tuMa.congPhapTuMa.showMenuThangCap();
                                break;
                            case 2:
                                player.tuMa.congPhapTuMa.showMenuThangPham();
                                break;
                            case 3:
                    ...
                    case ConstNpc.MENU_BASE_TU_MA:
                        switch (select) {
                            ...
                            case 4:
                                ...
                                break;
                            case 5:
                                player.tuMa.luyenCot.openMenuLuyenCot();
                                break;
                        }
                        break;
                    case ConstNpc.MENU_LUYEN_COT:
                        switch (select) {
                            case 0:
                                player.tuMa.luyenCot.showMenuLuyenCot();
                                break;
                            case 1:
                                player.tuMa.luyenCot.showMenuDotPhaTang();
                                break;
                            case 2:
                                player.tuMa.luyenCot.showHuongDanLuyenCot();
                                break;
                            default:
                        ...
                        break;
                    case ConstNpc.MENU_CONFIRM_LUYEN_COT:
                        if (select == 0) {
                            player.tuMa.luyenCot.luyenCot();
                        }
                        break;
                    case ConstNpc.MENU_DOT_PHA_TANG:
                        if (select == 0) {
                            player.tuMa.luyenCot.dotphatang();
                        }
                        break;
                    case ConstNpc.MENU_MA_TU_DOT_PHA:
                        if (select == 0) {
                            ...
                            if (!player.tuMa.canLevelUp()) {
                                Service.gI().sendThongBao(player, "Chưa đủ tu vi hoặc cấp công pháp để đột phá");
                                return;
                            }
                    ...
                    case ConstNpc.MENU_DUONG_LINH_CAN:
                        ...
                        break;
                    case ConstNpc.MENU_CP_TU_TIEN:
                        switch (select) {
                            case 0:
                                player.tuTien.congPhap.showMenuTangCap();
                                break;
                            case 1:
                                player.tuTien.congPhap.showMenuTangPham();
                                break;
                            case 2:
                                player.tuTien.congPhap.showThuocTinh();
                                break;
                        }
                        break;
                    ...
                    case ConstNpc.LINH_KHI_SETTING:
                        switch (select) {
                            case 0:
                                player.tuTien.isAttackWithLinhCan = !player.tuTien.isAttackWithLinhCan;
                                Service.gI().sendThongBao(player, "Đã" + (player.tuTien.isAttackWithLinhCan ? "Mở" : "Đóng") + " Sát thương linh căn");
                                // reopen
                    ...
                    case ConstNpc.MENU_PHU_CHU_SU:
                        ...
                        break;
                    case ConstNpc.MENU_CO_DUYEN:
                        if (player.tuTien.currentCoDuyen != null) {
                            CoDuyen.LuaChon luaChon = player.tuTien.currentCoDuyen.getLuaChons().get(select);
                            luaChon.getHandle().onSelect(player, player.tuTien.currentCoDuyen, luaChon);
                            player.tuTien.currentCoDuyen = null;
                        }
                        break;
                    ...
                    case ConstNpc.VK_SHOW_BASE:
                        ...
                        break;
                    case ConstNpc.BASE_MENU_TC:
                        switch (select) {
                            case 0:
                                player.theChat.showMenuPhaGiai();
                                break;
                            case 1:
                                player.theChat.showMenuTayTuy();
                                break;
                        }
                        break;
                    case ConstNpc.MENU_PHA_GIAI:
                        if (select == 0) {
                            player.theChat.phaGiai();
                        }
                        if (select == 1) {
                            player.theChat.showBaseMenu();
                        }
                        break;
                    case ConstNpc.MENU_TAY_TUY:
                        if (select == 0) {
                            player.theChat.tayTuy();
                        }
                        if (select == 1) {
                            player.theChat.showBaseMenu();
                        }
                    ...
                    case ConstNpc.MENU_TP_VK:
                        player.luyenThe.showVoKy();
                        break;
                    case ConstNpc.MENU_DOI_CP_LT:
                        if (select == 0) {
                            player.luyenThe.showDoiCongPhapMenu(player.iDMark.congPhapLt);
                        } else if (select == 1) {
                            player.luyenThe.congPhapLuyenThe.nuotCongPhap(player.iDMark.congPhapLt);
                        }
                        break;
                    case ConstNpc.MENU_D_CP_LT_CF:
                        if (select == 0) {
                            player.luyenThe.congPhapLuyenThe.doiCongPhap(player.iDMark.congPhapLt);
                        }
                        break;
                    case ConstNpc.CONFIRM_DOT_PHA_LUYEN_THE:
                        if (select == 0) {
                            ...
                            int nextLevel = (player.luyenThe.level + 1);
                    ...
                    case ConstNpc.MENU_PLAYER_TU_TIEN:
                        switch (select) {
                            case 0:
                                // hien thong tin buff hien tai
                                player.tuTien.showMenuTuTien();
                                break;
                            case 1:
                                player.tuTien.congPhap.showBaseMenu();
                                break;
                            case 2:
                                player.tuTien.showMenuTienPhap();
                                break;
                            case 3:
                                player.tuTien.linhCan.showMenuLinhCan();
                                break;
                    ...
                    case ConstNpc.TU_TIEN_DOT_PHA:
                        int subLevel = player.tuTien.subLevel;
                        if (subLevel == 10) {
                            int nextLv = player.tuTien.level + 1;
                            if (nextLv > player.tuTien.congPhap.level) {
                                Service.gI().sendThongBao(player, "Cấp công pháp không đủ để đột phá cảnh giới");
                                return;
                            }
                        }
                        ...
                        if (!player.tuTien.canHandleWithLinhKhiPoint(50)) {
                            Service.gI().sendThongBao(player, "Cần 50% tổng lượng linh khí để đột phá");
                            return;
                        }
                        if (player.tuTien.subLevel == 10) {
                            switch (select) {
                                case 0:
                                    ...
                                    float ratio = (player.tuTien.getLevelUpPercent() / 20f) + player.tuTien.congPhap.tangTyLeDotPhaThienDao;
                    ...
                    case ConstNpc.TU_TIEN_TAN_CONG:
                        if (select == 0) {
                            player.tuTien.tanCong();
                        }
                        break;
                    case ConstNpc.MENU_BASE_GIAO_DICH:
                        switch (select) {
                            case 0:
                                if (player.iDMark.gdMenuType == 0) {
                                    // dat vat pham
                                    SanGiaoDichService.getI().createDatVatPhamGiaoDichForm(player);
                                } else {
                                    // khoa diao dich
                                    SanGiaoDichService.getI().khoaGd(player);
                                }
                                break;
                            case 1:
                                if (player.iDMark.gdMenuType == 0) {
                                    ...
                                    player.iDMark.currentGiaoDich.huyGiaoDich(player);
                                }
                                break;
                            case 2:
                                if (player.iDMark.gdMenuType == 0) {
                                    ...
                                    player.iDMark.currentGiaoDich.takeItem(player);
                                }
                                break;
                            case 3:
                                player.iDMark.currentGiaoDich.takeItem(player);
                        ...
                        break;
                    case ConstNpc.BASE_MENU_GD:
                        switch (select) {
                            case 0:
                                SanGiaoDichService.getI().createGiaoDichForm(player);
                                // mở menu tạo giao dịch mới
                                break;
                            case 1:
                                SanGiaoDichService.getI().createHuyGiaoDichForm(player);
                                break;
                            case 2:
                                SanGiaoDichService.getI().createInfoGiaoDichForm(player);
                                break;
                        }
                        break;
                    case ConstNpc.IGNORE_MENU:
...
//                            Service.getInstance().sendThongBao(player, "Chức năng đang bảo trì");
                    ...
                    case ConstNpc.BAN_PLAYER:
                        if (select == 0) {
                            ...
                            Input.log_Follow_Admin(player.getSession().uu, ((Player) PLAYERID_OBJECT.get(player.id)).name, "Band Nick", null, null, 1);
                        }
                        break;
                    ...
                    case ConstNpc.MENU_TIEN_HOA:
                        ...
                        break;
                    case ConstNpc.MENU_CHON_CAP_BT:
                        player.iDMark.capCheBongTai = (byte) select;
                        CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.CHE_TAO_BT);
                        break;
                    case ConstNpc.MENU_ALL_TU_TIEN:
                        switch (select) {
                            case 0:
                                Service.gI().chat(player, "tu");
                                break;
                            case 1:
                                Service.gI().chat(player, "tthm");
                                break;
                            case 2:
                                player.theChat.showBaseMenu();
                                break;
                            case 3:
                                player.showMenuNghePhu();
                                break;
                        }
                        break;
                    case ConstNpc.MENU_ALL_TU_MA:
                        switch (select) {
                            case 0:
                                Service.gI().chat(player, "ma");
                                break;
                            case 1:
                                Service.gI().chat(player, "tthm");
                                break;
                        ...
                        break;
                    case ConstNpc.MENU_ALL_LUYEN_THE:
                        switch (select) {
                            case 0:
                                Service.gI().chat(player, "lt");
                                break;
                            case 1:
                                Service.gI().chat(player, "tthm");
                                break;
                        ...
                        break;
                    case ConstNpc.MENU_ALL_LUC_NGHE:
                        switch (select) {
                            case 0:
                                Service.gI().chat(player, "ttlt");
                                break;
                            case 1:
                                Service.gI().chat(player, "ttld");
                                break;
                            case 2:
                                Service.gI().chat(player, "ttlk");
                                break;
                            case 3:
                                Service.gI().chat(player, "ttpc");
                                break;
                            case 4:
                                Service.gI().chat(player, "tttp");
                                break;
                            case 5:
                                Service.gI().chat(player, "ttkt");
                                break;
                            case 6:
                                Service.gI().chat(player, "ttnt");
                                break;
                            case 7:
                                player.showMenuAutoNghePhu();
                                break;
                        ...
                        switch (select) {
                            ...
                            case 4 -> {
                                if (player.petDaoLu.pointCapTinh < player.petDaoLu.getMaxTinh()) {
                                    NpcService.gI().createMenuConMeo(player, ConstNpc.DAO_LU_THANG_TINH, 12679, "|7|THĂNG TINH ĐẠO LỮ\n\n" + "|1|Tên: " + player.petDaoLu.nameDaoLu + "\nCấp Bậc:" + player.petDaoLu.getCapBacCapTinh() + "\n|2|Tu Vi Đang Có: " + player.petDaoLu.pointTuVi + "/1000" + "\nThăng Tinh Lúc Này Tiêu Hao Toàn Bộ Tu Vi" + "\nCần Tối Thiểu 600 Tu Vi Để Thăng Tinh" + "\n Tỷ Lệ Thành Công " + player.petDaoLu.getTiLeThangTinh() + "%" + "\n\n|2|Lưu Ý, Tu Vi Càng Cao, Tỷ Lệ Càng Cao!!!", "Đột Phá\nTu Vi", "Quay Lại\nThông Tin");
                                } else {
                                    NpcService.gI().createMenuConMeo(player, ConstNpc.DAO_LU_IGNORE, 12679, "|7|THĂNG TINH ĐẠO LỮ\n\n" + "|1|Tên: " + player.petDaoLu.nameDaoLu + "\nCấp Bậc:" + player.petDaoLu.getCapBacCapTinh() + "\n|2|Tu Vi Đang Có: " + player.petDaoLu.pointTuVi + "/1000" + "\n\nCảnh Tinh của ngươi đã đạt tối đa...!", "Quay Lại\nThông Tin");
                                }
                            }
                            case 5 -> {
                                if (player.petDaoLu.pointCapCanhGioi < ConstPet.MAX_CAP_BAC_DAO_LU - 1 && player.petDaoLu.pointCapTinh >= player.petDaoLu.getMaxTinh()) {
                                    NpcService.gI().createMenuConMeo(player, ConstNpc.DAO_LU_THANG_BAC, 12679, "|7|ĐỘT PHÁ CẢNH GIỚI ĐẠO LỮ\n\n" + "|1|Tên: " + player.petDaoLu.nameDaoLu + "\nCấp Bậc:" + player.petDaoLu.getCapBacCapTinh() + "\n|2|Tu Vi Đang Có: " + player.petDaoLu.pointTuVi + "/1000" + "\nThăng Cấp Cảnh Giới Sẽ Tiêu Hao Toàn Bộ Tu Vi" + "\nPhải Đạt Max 1000 Tu Vi Mới Có Thể Thăng Cấp Cảnh Giới" + "\n Tỷ Lệ Thành Công " + player.petDaoLu.getTiLeThangCanhGioi() + "%" + "\n\n|2|Lưu Ý, Nếu Thất Bại Bạn Sẽ Bị Giảm 7 Cấp Tinh Của Cấp Hiện Tại!!!", "Đột Phá\nCấp Bậc", "Quay Lại\nThông Tin");
                                } else if (player.petDaoLu.pointCapCanhGioi == ConstPet.MAX_CAP_BAC_DAO_LU - 1 && player.petDaoLu.pointCapTinh >= player.petDaoLu.getMaxTinh()) {
                                    NpcService.gI().createMenuConMeo(player, ConstNpc.DAO_LU_THANG_DAU_DE, 12679, "|7|ĐỘT PHÁ ĐẤU ĐẾ\n\n" + "|1|Tên: " + player.petDaoLu.nameDaoLu + "\nCấp Bậc:" + player.petDaoLu.getCapBacCapTinh() + "\n|2|Tu Vi Đang Có: " + player.petDaoLu.pointTuVi + "/1000" + "\n\nĐột Phá Cần Tất Cả Loại Đan Mỗi Loại Số Lượng 1000 Viên Và 4 Mảnh Đà Xá Cổ Đế!", "Đột Phá\nĐấu Đế", "Quay Lại\nThông Tin");
                                } else if (player.petDaoLu.pointCapCanhGioi == ConstPet.MAX_CAP_BAC_DAO_LU) {
                                    NpcService.gI().createMenuConMeo(player, ConstNpc.DAO_LU_IGNORE, 12679, "|7|CẢNH GIỚI CAO NHẤT\n\n" + "|1|Tên: " + player.petDaoLu.nameDaoLu + "\nCấp Bậc:" + player.petDaoLu.getCapBacCapTinh() + "\n|2|Tu Vi Đang Có: " + player.petDaoLu.pointTuVi + "/1000" + "\n\nNgươi đã đạt cảnh giới cao nhất...!", "Quay Lại\nThông Tin");
                                } else {
                                    NpcService.gI().createMenuConMeo(player, ConstNpc.DAO_LU_IGNORE, 12679, "|7|ĐỘT PHÁ CẢNH GIỚI ĐẠO LỮ\n\n" + "|1|Tên: " + player.petDaoLu.nameDaoLu + "\nCấp Bậc:" + player.petDaoLu.getCapBacCapTinh() + "\n|2|Tu Vi Đang Có: " + player.petDaoLu.pointTuVi + "/1000" + "\n\nChưa thể đột phá đâu, luyện thêm đi...!", "Quay Lại\nThông Tin");
                                }
                            }
                                    ...
                                    new Thread(() -> {
                                        if (!Manager.haveEffectNightSky) {
                                            ...
                                            try {
                                                ...
                                                String[] str = {"Khí tức áp bức này quá khủng khiếp", "Đấu đế... là đấu đế!!", Util.clearKeywordVip(player.name) + " không ngờ có thể luyện Đạo Lữ đến cảnh giới này!!..", "Mauuu, mau quỳ xuống!"};
                                                for (Player pl : pls) {
                                                    if (pl != player) {
                            ...
                            case 1:
                                ...
                                if (!TaiXiu.gI().baotri) {
                                    if (player.goldTai == 0 && player.goldXiu == 0) {
                                        ...
                                        createOtherMenu(player, ConstNpc.TAIXIU, "\n|7|---NHÀ CÁI TÀI XỈU---\n\n|3|Kết quả kì trước:  " + TaiXiu.gI().x + " : " + TaiXiu.gI().y + " : " + TaiXiu.gI().z + "\n\n|6|Tổng nhà TÀI: " + Util.format(TaiXiu.gI().goldTai) + " Điểm nạp" + "\n\nTổng nhà XỈU: " + Util.format(TaiXiu.gI().goldXiu) + " Điểm nạp\n\n|5|Thời gian còn lại: " + time + "\n\n|7|Bạn đã cược Tài : " + Util.format(player.goldTai) + " Điểm nạp", "Cập nhập", "Đóng");
                                    } else {
                                        createOtherMenu(player, ConstNpc.TAIXIU, "\n|7|---NHÀ CÁI TÀI XỈU---\n\n|3|Kết quả kì trước:  " + TaiXiu.gI().x + " : " + TaiXiu.gI().y + " : " + TaiXiu.gI().z + "\n\n|6|Tổng nhà TÀI: " + Util.format(TaiXiu.gI().goldTai) + " Điểm nạp" + "\n\nTổng nhà XỈU: " + Util.format(TaiXiu.gI().goldXiu) + " Điểm nạp\n\n|5|Thời gian còn lại: " + time + "\n\n|7|Bạn đã cược Xỉu : " + Util.format(player.goldXiu) + " Điểm nạp", "Cập nhập", "Đóng");
                                    }
                                } else if (player.goldTai == 0 && player.goldXiu == 0) {
                                    createOtherMenu(player, ConstNpc.TAIXIU, "\n|7|---NHÀ CÁI TÀI XỈU---\n\n|3|Kết quả kì trước:  " + TaiXiu.gI().x + " : " + TaiXiu.gI().y + " : " + TaiXiu.gI().z + "\n\n|6|Tổng nhà TÀI: " + Util.format(TaiXiu.gI().goldTai) + " Điểm nạp" + "\n\nTổng nhà XỈU: " + Util.format(TaiXiu.gI().goldXiu) + " Điểm nạp\n\n|5|Thời gian còn lại: " + time + "\n\n|7|Hệ thống sắp bảo trì", "Cập nhập", "Đóng");
                                } else if (player.goldTai > 0) {
                                    createOtherMenu(player, ConstNpc.TAIXIU, "\n|7|---NHÀ CÁI TÀI XỈU---\n\n|3|Kết quả kì trước:  " + TaiXiu.gI().x + " : " + TaiXiu.gI().y + " : " + TaiXiu.gI().z + "\n\n|6|Tổng nhà TÀI: " + Util.format(TaiXiu.gI().goldTai) + " Điểm nạp" + "\n\nTổng nhà XỈU: " + Util.format(TaiXiu.gI().goldXiu) + " Điểm nạp\n\n|5|Thời gian còn lại: " + time + "\n\n|7|Bạn đã cược Tài : " + Util.format(player.goldTai) + " Điểm nạp" + "\n\n|7|Hệ thống sắp bảo trì", "Cập nhập", "Đóng");
                                } else {
                                    createOtherMenu(player, ConstNpc.TAIXIU, "\n|7|---NHÀ CÁI TÀI-XỈU---\n\n|3|Kết quả kì trước:  " + TaiXiu.gI().x + " : " + TaiXiu.gI().y + " : " + TaiXiu.gI().z + "\n\n|6|Tổng nhà TÀI: " + Util.format(TaiXiu.gI().goldTai) + " Điểm nạp" + "\n\nTổng nhà XỈU: " + Util.format(TaiXiu.gI().goldXiu) + " Điểm nạp\n\n|5|Thời gian còn lại: " + time + "\n\n|7|Bạn đã cược Xỉu : " + Util.format(player.goldXiu) + " Điểm nạp" + "\n\n|7|Hệ thống sắp bảo trì", "Cập nhập", "Đóng");
                                }
                                break;
                        }
                        break;
                        ...
                        switch (select) {
                            case 0:
                                ...
                                Thread thread = new Thread(() -> {
                                    try {
                                        while (player.autocso && player.autoHP && player.nPoint != null) {
                            ...
                            case 1:
                                ...
                                Thread thread1 = new Thread(() -> {
                                    try {
                                        while (player.autocso && player.autoKI && player.nPoint != null) {
                            ...
                            case 2:
                                ...
                                Thread thread2 = new Thread(() -> {
                                    try {
                                        while (player.autocso && player.autoSD && player.nPoint != null) {
                            ...
                            case 3:
                                ...
                                Thread thread3 = new Thread(() -> {
                                    try {
                                        while (player.autocso && player.autoGiap && player.nPoint != null) {
