...
public class ItemService {
    ...
    public void setsencon(Player player) throws Exception {
        ...
        gang.itemOptions.add(new Item.ItemOption(137, 1));
        giay.itemOptions.add(new Item.ItemOption(137, 1));
        nhan.itemOptions.add(new Item.ItemOption(13, 71));
        //kakarot
        ao.itemOptions.add(new Item.ItemOption(133, 1));
        quan.itemOptions.add(new Item.ItemOption(133, 1));
        gang.itemOptions.add(new Item.ItemOption(133, 1));
    ...
    public void openSKHJiren(Player player, int optionSKH) throws Exception {
        if (InventoryServiceNew.gI().getCountEmptyBag(player) > 4) {
            ...
            if (hq != null) {
                ...
                ao.itemOptions.add(new Item.ItemOption(optionSKH, 1));
                ao.itemOptions.add(new Item.ItemOption(ItemService.gI().optionIdSKH(optionSKH), 1));

                Item quan = Util.ratiItemSKHJiren(1520);
                quan.itemOptions.add(new Item.ItemOption(optionSKH, 1));
                quan.itemOptions.add(new Item.ItemOption(ItemService.gI().optionIdSKH(optionSKH), 1));
                Item gang = Util.ratiItemSKHJiren(1521);
                gang.itemOptions.add(new Item.ItemOption(optionSKH, 1));
                gang.itemOptions.add(new Item.ItemOption(ItemService.gI().optionIdSKH(optionSKH), 1));

                Item giay = Util.ratiItemSKHJiren(1522);
                giay.itemOptions.add(new Item.ItemOption(optionSKH, 1));
                giay.itemOptions.add(new Item.ItemOption(ItemService.gI().optionIdSKH(optionSKH), 1));

                Item nhan = Util.ratiItemSKHJiren(1523);
                nhan.itemOptions.add(new Item.ItemOption(optionSKH, 1));
                nhan.itemOptions.add(new Item.ItemOption(ItemService.gI().optionIdSKH(optionSKH), 1));
