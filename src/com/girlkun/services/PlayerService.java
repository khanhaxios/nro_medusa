...
public class PlayerService {
    ...
    public void hoiPhuc(Player player, double hp, double mp) {
        if (!player.isDie()) {
            ...
            if (!player.isPet && !player.isDaoLu && !player.isNewPet && !player.isTrieuhoipet) {
    ...
    public void playerMove(Player player, int x, int y) {
        ...
        if (!player.isDie()) {
            ...
            switch (player.zone.map.mapId) {
                ...
                case 90:
                case 91:
                    if (!player.isBoss && !player.isPet && !player.isDaoLu && !player.isTrieuhoipet) {
    ...
    private static final int COST_GEM_HOI_SINH = 3000;
