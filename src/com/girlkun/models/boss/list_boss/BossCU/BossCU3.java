 ...
 * @@Edit by ndq
 */
public class BossCU3 extends Boss {

    public BossCU3() throws Exception {
        super(BossID.GOKU_ROSE_S, BossesData.GOKU_ROSE_S);
    }
    ...
    public void reward(Player plKill) {
        ...
        ItemMap it = new ItemMap(this.zone, 1428, 30000, this.location.x, this.zone.map.yPhysicInTop(this.location.x,
