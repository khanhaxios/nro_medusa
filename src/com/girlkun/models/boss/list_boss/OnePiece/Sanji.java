 ...
 */
public class Sanji extends Boss {

    public Sanji() throws Exception {
        super(BossID.VINSMOKE_SANJI, BossesData.VINSMOKE_SANJI);
    }

    @Override
    public void reward(Player plKill) {
        int[] itemDos = new int[]{1166}; //1166
