...
//            String violate = dataArray.toJSONString();
            ...
            GirlkunDB.executeUpdate("insert into player" + "(account_id, name, head, gender, have_tennis_space_ship, clan_id_sv" + Manager.SERVER + ", " + "data_inventory, data_location, data_point, data_magic_tree, items_body, " + "items_bag, items_box, items_box_lucky_round, friends, enemies, " + "data_intrinsic, data_item_time, data_item_time_sieucap," + "data_task, data_mabu_egg, data_dua, Tai_xiu, data_charm, skills, skills_shortcut, pet, dao_lu," + "data_black_ball, data_side_task, violate, pointPvp, info_phoban, info_achievement, data_card, Thu_TrieuHoi, nhiemvu_chienthan,lucky_pool,last_time_clan) " + "values ()", userId, name, hair, gender, 0, -1, inventory, location, point, magicTree, itemsBody, itemsBag, itemsBox, itemsBoxLuckyRound, friends, enemies, intrinsic, itemTime, itemTimeSieuCap, task, mabuEgg, timedua, taixiu, charms, skills, skillsShortcut, petData, dao_lu, dataBlackBall, dataSideTask, 0, pointPvp, info_phoban, info_achive, data_card, trieuhoithu, chienthan, dataLyckuPool, System.currentTimeMillis());
