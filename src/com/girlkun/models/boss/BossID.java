...
//    public static final int TRUNG_UY_TRANG = -200;
    ...
    ///
    public static final int BOSS_ADMIN = -260;
    public static final int BOSS_ADMIN2 = -261;
    public static final int BOSS_ADMIN3 = -262;
    public static final int BOSS_ADMIN4 = -263;
    public static final int BOSS_ADMIN5 = -264;
    public static final int BOSS_NOEL = -265;
    public static final int BOSS_TG = -266;
    ...
    public static final int BOSS_MOI1 = -259;
    public static final int BOSS_MOI2 = -267;
    public static final int BOSS_MOI3 = -268;
    public static final int BOSS_MOI4 = -269;
    public static final int BOSS_MOI5 = -270;
    public static final int BOSS_MOI6 = -271;
    public static final int BOSS_MOI7 = -272;
    public static final int BOSS_MOI8 = -273;
    public static final int BOSS_MOI9 = -274;
    public static final int BOSS_MOI10 = -275;
    public static final int BOSS_HAC = -276;
    public static final int BOSS_HAC1 = -277;
    public static final int BOSS_HAC2 = -278;
    public static final int BOSS_HAC3 = -279;
    public static final int BOSS_HAC4 = -281;
    public static final int BOSS_HAC5 = -282;
    public static final int BOSS_HAC6 = -283;
    public static final int BOSS_HAC7 = -284;
    public static final int BOSS_ZENO2 = -280;
    public static final int BOSS_ZENO3 = -333;
    public static final int BOSS_TET = -285; 
    public static final int BOSS_TET2 = -286;
    public static final int BOSS_TET3 = -287;
    public static final int BOSS_TET4 = -288;
    public static final int BOSS_MA = -289;
    public static final int BOSS_THAN = -290;
    public static final int BOSS_TET5 = -291; 
    public static final int BOSS_TET6 = -292;
    public static final int BOSS_TET7 = -293;
    public static final int BOSS_TET8 = -294;
    public static final int BOSS_TET9 = -295; 
    public static final int BOSS_TET10 = -296;
    public static final int BOSS_TET11 = -297;
    public static final int GOKU_ROSE_N = -298;
    public static final int GOKU_ROSE_R = -299;
    public static final int GOKU_ROSE_S = -300;
    public static final int GOKU_ROSE_NT = -301;
    public static final int UCHIHA_S = -302;
    public static final int UCHIHA_SS = -303;
    public static final int UCHIHA_SSS = -304;
    public static final int UCHIHA_TT = -305;
    public static final int BOSS_VANG = -306;
    public static final int BOSS_NGOC = -307;
    public static final int BOSS_VANG1 = -308;
    public static final int BOSS_NGOC1 = -309;
    public static final int BOSS_NGOC2 = -310;
    
    public static final int LUFFY = -311;
    public static final int RORONOA_ZORO = -312;
    public static final int VINSMOKE_SANJI = -313;
    public static final int NICO_ROBIN = -314;
    public static final int FRANKY = -315;
    public static final int BROOK = -316;
    public static final int NAMI = -317;
    public static final int CHOPPER = -318;
    public static final int USOPP = -319;
    public static final int KAIDO = -320;
    public static final int LUFFY_GEAR_FIVE_FIGHT_KAIDO = -321;
    ...
    public static final int BOSS_CAPYBARA = -327;
