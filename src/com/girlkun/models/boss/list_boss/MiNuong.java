...
//    }
    ...
    public void reward(Player plKill) {
        int a = 0;
        for (int i = 0; i < 20; i++) {
            ItemMap it = new ItemMap(this.zone, 861, 250, this.location.x + a, this.zone.map.yPhysicInTop(this.location.x,
...
//        }
        ...
        if (Util.getDistance(playerTarger, this) > 500 && this.zone == this.playerTarger.zone) {
            Service.gI().sendThongBao(this.playerTarger, "|7|Đi quá xa , Bé Quỳnh  ĐÃ rời đi ! ");
        ...
        if (Util.getDistance(playerTarger, this) > 300 && this.zone == this.playerTarger.zone) {
            Service.gI().sendThongBao(this.playerTarger, "|7|Khoảng cách quá xa, Bé Quỳnh SẮP rời xa bạn!! ");
        }
