...
//        return 10000;
    ...
    public static Skill getSkillByItemID(Player pl, int tempId) {
        ...
        } else if (tempId >= 1565 && tempId <= 1569) {
            return getSkillbyId(pl, Skill.BIEN_HINH_TD);
        } else if (tempId >= 1570 && tempId <= 1574) {
            return getSkillbyId(pl, Skill.BIEN_HINH_NM);
        } else if (tempId >= 1575 && tempId <= 1579) {
    ...
    public static boolean containXaydaSkill(Skill skillSelect) {
        return skillSelect.template.id == Skill.GALICK || skillSelect.template.id == Skill.ANTOMIC;
    }
}
